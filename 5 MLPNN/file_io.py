...
def mnist(root = "C:\\Users\\86137\\Desktop\\study\\DeepLearning\\FuDan-2022-DeepLearning\\0 dataset\\mnist\\"):
    # 需要根据文件在设备的路径获取数据
    train_x = decode_idx3(root+'train-images.idx3-ubyte').reshape(60000,784)[0:60000:1]
    train_y = decode_idx1(root+'train-labels.idx1-ubyte')[0:60000:1]

    test_x = decode_idx3(root+'t10k-images.idx3-ubyte').reshape(10000, 784)[0:10000:4]
    test_y = decode_idx1(root+'t10k-labels.idx1-ubyte')[0:10000:4]
